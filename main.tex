...
We present a process to transform the sequencing information used for genotyping new individuals into a feature representation that 
...
\section{PrecisionFDA Consistency Challenge}
...
The loss is reported on 100 held out regions of the genome on a different sample of the genome. 
